...
# This is the script that is used to provision the web host
...
apt_install_prerequisites() {
    # For WordPress: PHP 7.3+, Apache httpd or Nginx, MariaDB 10.1+ or MySQL 5.6+
    # For WSO2 Sample Applications, Apache Tomcat 8, OpenJDK 8
